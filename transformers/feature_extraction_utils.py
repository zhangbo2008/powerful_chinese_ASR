...
class FeatureExtractionMixin:
    ...
    def get_feature_extractor_dict(
        ...
        Returns:
            ...
            object.
        """ #   学习hf项目的整个架构. 都是软降工程的经典思路.包括里面各种鲁棒性的考虑都是代码里面素质最高的.
        cache_dir = kwargs.pop("cache_dir", None)  # 首先的思路是对于用户自己赔偿之的字典kwargs.用pop来抽取里面的value来进行配置. 并且要配置好pop的默认项. 里面pop显然越抽取字典越小.所以也是一个提高性能的技巧点.学习了.
        ...
        try:
            ...
            with open(resolved_feature_extractor_file, "r", encoding="utf-8") as reader:# 然后进行读取里面数据
                text = reader.read()
