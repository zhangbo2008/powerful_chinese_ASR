...
class PreTrainedModel(nn.Module, ModuleUtilsMixin, GenerationMixin, PushToHubMixin):
    ...
    def init_weights(self):
        ...
        if self.config.pruned_heads: # 根据配置文件修改头.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs):
        ...
        if not isinstance(config, PretrainedConfig): # 读取配置.
        ...
        if from_tf:
            ...
            if state_dict is None:
                try:
                    state_dict = torch.load(resolved_archive_file, map_location="cpu") # 加载权重.
                except Exception:
                    raise OSError(
...
# 加载模型训练好的权重.!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    def _load_state_dict_into_model(cls, model, state_dict, pretrained_model_name_or_path, _fast_init=True):
        ...
        # Convert old format to new format if needed from a PyTorch state_dict # 保证对旧模型命名的鲁邦性.
        old_keys = []
        new_keys = []
